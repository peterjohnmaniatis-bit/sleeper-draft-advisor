...
LINES = {
    ...
    "outcome-disaster": [
        "{player} at {pick}, finished {finished}. That's {miss} places of pure, uncut dogshit, {mgr}.",
        "Pick {pick}. Finished {finished}. You didn't draft a {pos}, {mgr}, you drafted a fucking hole {miss} spots deep.",
        "{miss} spots short. Not a dip, not a slump — a goddamn sinkhole with {player}'s name on it.",
        "Took {player} {pick} overall, got {finished}. Somewhere a waiver-wire nobody is laughing his ass off at you.",
        "Round {rnd}, pick {pick}, finish {finished}. {mgr} torched the whole fucking draft inside the first hour.",
        "There's bad, and then there's {miss}-places bad. {player} went {pick} and came back {finished} like he owed you money and skipped town.",
        "{mgr} used pick {pick} like it was a dare. {player} finished {finished}. Dare fucking accepted.",
        "The {miss}-spot faceplant. Drafted {pick}. Finished {finished}. Nobody has brought it up since.",
        "Nobody made you take {player} at {pick}. Nobody. He finishes {finished} and it's your goddamn name on the receipt, {mgr}.",
        "{finished}. From pick {pick}. That's not a miss, that's a dumpster fire {miss} places wide.",
        "Short version: {pick} in, {finished} out, {miss} straight into the shitter.",
        "{player} was your {pos}1 at {pick} and finished {finished}. {mgr} built the whole fucking house on a swamp.",
        "{miss} spots below his own slot. At some point that stops being variance, {mgr}, and starts being a horseshit decision.",
        "Drafted {pick}, finished {finished}. {miss} spots of dead weight, and not one ounce of fucking remorse.",
        "Congrats, {mgr}: pick {pick} returned a {finished} finish. Setting cash on fire in a goddamn wind tunnel would have been faster.",
        "The board was loaded and {mgr} took {player} at {pick}. Finished {finished}. Un-fucking-believable.",
        "{miss}. That's the number. Everything else is noise around {player} going {pick} and showing up {finished}.",
        "A {rnd}-round asset that finishes {finished} isn't an asset. It's a fucking apology with a helmet on.",
        "{mgr} paid pick {pick} and collected {miss} spots of regret. No refunds, no sympathy, no fucking mercy.",
        "Deadpan take: taken {pick}, finished {finished}. Honest take: what in the actual fuck was that.",
        "{player} finished {finished} after going {pick}. Your bench had better {pos}s, and your bench was fucking landfill.",
        "{miss} places. Pull a name out of a hat and you beat pick {pick} by a country fucking mile.",
        "This is the pick that ate the season: {pick} overall, {finished} at the end, {miss} spots of pure shit in between.",
        "{mgr}, when you called {player} at {pick} the room went quiet. The room fucking knew. {finished}.",
        "Finished {finished}. Drafted {pick}. Squint all you want, it's still a shitshow.",
        "{miss} spots under slot is a hell of a way to say you had a plan. The plan was ass, {mgr}.",
        "You spent pick {pick} and received {finished}. That's not a draft pick, that's a fucking donation.",
        "Draft slot {pick}. Final rank {finished}. Gap of {miss}. No further questions.",
        "{player} at {pick} was a statement pick. The statement was {finished}. Bold as hell, dumb as fuck.",
        "{miss} places of fuck-all out of a pick that cost {pick} overall. {mgr} paid premium for a ghost.",
        "Every league needs a cautionary tale and {mgr} volunteered: {player}, taken {pick}, finished {finished}, {miss} spots of ruin.",
    ],
    "outcome-miss": [
        "Drafted {pick}, finished {finished}. {miss} spots of pure fucking shrug.",
        "{miss} places short. Not a fire, {mgr}, just a room that never got warm.",
        "You spent pick {pick} on {player} and finished {finished} with him. Cool. Real fucking cool.",
        "{finished} out of a {pick} slot. That's {miss} spots of \"he's due,\" week after goddamn week.",
        "Nobody died. {player} just quietly came up {miss} spots short and acted like that was normal.",
        "Round {rnd} money for a {finished} finish. {miss} places of buyer's remorse, and you paid full fucking freight.",
        "{player} finished {finished} after going {pick}. He wasn't bad. He was worse than bad. He was fine.",
        "{miss} spots. Enough to piss you off, not enough to blame anybody but yourself.",
        "Pick {pick}. Finish {finished}. Somewhere in that {miss}-spot gap is your whole fucking season.",
        "This is the miss nobody brings up at the draft party. {miss} spots, no explosion, just a slow shitty fade.",
        "{mgr} took {player} at {pick} and got {finished}. That's a bad haircut, not a house fire. Still fucking ugly for months.",
        "Every Sunday he put up nothing much and you said \"okay\" like a fucking hostage. {miss} spots of okay.",
        "A {pos} taken at {pick} has one damn job. {finished} was not it.",
        "You didn't lose the league here. You just came out {miss} spots poorer and had to pretend that was the plan.",
        "{player} at {pick}, {finished} at the buzzer. {miss} places of \"why the fuck is he still in my lineup.\"",
        "Not a bust. Just a {miss}-spot letdown that had you refreshing the waiver wire every damn Tuesday.",
        "{pick} to {finished}. That gap has a name and the name is a long fucking sigh.",
        "{miss} spots under the slot. Middling, aggravating, and entirely your call.",
        "The pick wasn't dumb. The finish was {finished}, and dumb is exactly what {miss} spots feels like in fucking November.",
        "{mgr}, {player} went at {pick} and finished {finished}. Same guy, {miss} spots of disappointment, no fucking refund.",
        "A {miss}-place shortfall is the fantasy version of ordering steak and getting a fucking sandwich.",
        "{player}: {pick} in, {finished} out. He never ruined you. He also never once helped.",
        "{miss} spots. Not catastrophic. Just the kind of shit that turns 8-6 into 6-8.",
        "Took him {pick}. He landed {finished}. You'll defend this pick for years and you'll be wrong every damn time.",
        "{miss} places under his slot, and next year he'll go a round later and burn somebody else's roster instead. Fucking typical.",
        "Round {rnd} pick, {finished} season, {miss} spots of nothing. Hell of a way to spend a good slot, {mgr}.",
        "{player} spent the year being the {finished} guy while wearing a {pick} price tag. Fucking embarrassing, in a quiet way.",
        "{miss} spots. You noticed it in week 4 and did fuck-all about it until week 11.",
        "{pick} for {finished}. That's not a bust, {mgr}, that's a bad trade you made with your own damn self.",
        "You wanted a cornerstone at {pick}. You got {finished} and {miss} spots of quiet, grinding bullshit.",
        "The {miss}-spot miss: not loud, not fatal, just there every week like a shitty roommate.",
    ],
    "outcome-hit": [
        "{player} went {pick}, finished {finished}. That's {beat} spots of profit, which is the fantasy equivalent of finding a twenty in last year's coat. Fine. Good for you.",
        "Fucking fine, {mgr}. {pick} in, {finished} out, {beat} places to the good. Nobody's building a statue.",
        "Took {player} at {pick}. He finished {finished}. The scorecard is legally required to call that {beat} spots of value and is doing so through gritted teeth.",
        "{pick} to {finished} -- {beat} places better than his slot. Congratulations on the smallest correct fucking opinion of the night.",
        "Pick {pick}. Finish {finished}. {beat} places of daylight. It worked. Now shut up about it.",
        "Modest win: {player} beat his {pick} slot by {beat} and landed at {finished}. That's not a heist, that's a rounding error with a pulse. Still counts, you smug bastard.",
        "You drafted {player} {pick}th and he came in {finished}th. {beat} spots of gravy. Somewhere a broken clock nods.",
        "Give the man his {beat} places. {pick} in, {finished} out. Now take the microphone away.",
        "{mgr} spent pick {pick} on {player}, got {finished} out of it, and has told the group chat about those {beat} places every week since.",
        "It's a good pick. There, it's said. {pick} in, {finished} out, {beat} to the good, now go be insufferable somewhere else.",
        "{player} at {pick} finishing {finished} is the draft equivalent of parallel parking on the first try. Competent. Unremarkable. {beat} places of value, and not a damn one more.",
        "{beat} spots above where you took him. Not a windfall, not a disaster -- just a {pos} doing his goddamn job at {finished} after going {pick}.",
        "Pick {pick}, finish {finished}. The math says you were right by {beat}, and the math sounds annoyed about it.",
        "Nice {pos}, {mgr}. Taken {pick}, finished {finished}, {beat} places better than the slot you burned on him. That's the nicest sentence on this page, so frame the fucker.",
        "He went {pick} and finished {finished}. {beat} places of value, in the way a coupon is money.",
        "{beat} places ahead of the slot you spent at {pick}, home at {finished}. A quiet, boring, completely fucking adequate outcome.",
        "Drafted {player} in round {rnd} at {pick}. Finished {finished}. You didn't win the draft, you just didn't shit the bed. Take the {beat} and move on.",
        "Round {rnd}, pick {pick}, finish {finished}. {beat} places of upside and zero style points.",
        "You wanted him at {pick}, you got {finished}. {beat} in the black. Don't spend it all in one place, jackass.",
        "Correct, technically. {player} finished {finished} after going {pick}, {beat} spots better than owed. Enjoy the tiny, tiny fucking parade.",
        "{beat} places of profit. That's a win the way a tie is a win. Still, {pick} to {finished}, credit where it's due.",
        "Good pick. Actually good. {pick} to {finished}, {beat} to the good, and it kills me to fucking type it.",
        "{player} finished {finished}. He was taken {pick}. Somebody in this league can read a depth chart, apparently, and it's worth exactly {beat} places.",
        "The good news: {beat} spots of surplus. The bad news: {beat} spots, not fifty. {pick} in, {finished} out, applause withheld.",
        "Beat his {pick} slot by {beat} and landed at {finished}. Didn't break the draft, didn't break your heart. Fine work, {mgr} -- just don't get fucking smug about it.",
        "Taken {pick}. Finished {finished}. {beat} places to the good. That'll do. That'll genuinely do.",
        "This is what a functional pick looks like: {pick} in, {finished} out, {beat} places of quiet profit. Boring as hell and twice as useful.",
        "Hell of a boring win, {mgr}. {player} at {pick}, home at {finished}, {beat} places up. The scorecard has nothing mean to say and hates that.",
        "You took a {pos} at {pick} and he came back {finished}. {beat} places of value at a spot half this league screwed up. Fine. Fucking fine.",
    ],
    "outcome-steal": [
        "Taken {pick}. Finished {finished}. That's {beat} spots of pure fucking larceny and {mgr} didn't even flinch.",
        "{mgr} grabbed {player} at {pick} like it was nothing and got a {finished} finish out of it. {beat} places better than the slot. Un-fucking-believable.",
        "Nobody wanted {player} at {pick}. He finished {finished}. {mgr} beat his own damn pick by {beat} and has been insufferable ever since.",
        "{beat} spots ahead of where he was taken, and {finished} overall. {mgr} didn't draft {player} at {pick}, he fucking shoplifted him.",
        "Pick {pick} to {finished} is not a value, it's a fucking crime scene with {mgr}'s prints all over it. {beat} places.",
        "Round {rnd}. Pick {pick}. Finished {finished}. {beat} spots of free money, and no, {mgr}, you did not fucking see it coming.",
        "{player} went {pick} and finished {finished}. {beat} places better than his slot. Fine. Fucking fine. Take the win.",
        "Everyone let {player} slide to {pick}, and {mgr} turned that into a {finished} finish. {beat} spots the rest of us are still pissed about.",
        "{beat} places better than the pick. {mgr} found a {finished}-overall {pos} in the goddamn clearance bin at {pick}.",
        "Taken {pick}. Finished {finished}. Somebody check {mgr}'s laptop, because {beat} spots of luck like that is not fucking normal.",
        "A {pos} taken at {pick} has no business finishing {finished}. {beat} spots. Absolute horseshit, and it worked.",
        "{mgr} spent a nothing pick at {pick} and got {finished} out of it. {beat} places of upside, zero risk, zero thought.",
        "The room laughed at pick {pick}. The room stopped laughing by week six. {finished} on the year, {beat} spots ahead of slot.",
        "{beat} spots. That is the gap between {mgr}'s pick at {pick} and where {player} actually landed at {finished}.",
        "Drafted {pick}, finished {finished}. {mgr} banked {beat} spots on a guy he took because he liked the fucking name.",
        "{player} at {pick} was a shrug. {player} at {finished} was a fucking problem for everyone else. {beat} spots.",
        "{beat} places over slot, {finished} overall. Congrats to {mgr}, who will never shut up about pick {pick} as long as he fucking lives.",
        "That is a {finished} finish out of a pick at {pick}. {beat} spots of daylight. Even a broken clock lands one.",
        "Late-round {pos}, pick {pick}, ends up {finished}. {beat} spots better and not one goddamn word of real scouting behind it.",
        "{mgr} took {player} at {pick} and watched him finish {finished}. {beat} spots of production out of nothing. It's bullshit. It's also the best pick of his draft.",
        "Pick {pick}: whatever. Finish {finished}: oh, come on. {beat} places. That's a lottery ticket that fucking hit.",
        "{beat} spots ahead of his own slot and {finished} on the season. {mgr} drafted a bench body at {pick} and accidentally drafted a league winner. Shit like this shouldn't count.",
        "Nothing about taking {player} at {pick} was smart. Finishing {finished} made it look like genius. {beat} spots of fucking dumb luck, and we all know it.",
        "{beat}. That's the number. {pick} in, {finished} out. {mgr}'s one good decision all year, and he stumbled into it.",
        "Went at {pick}, finished {finished}. {mgr} got a first-rounder's season for scrap. {beat} places. Piss off.",
        "{beat} spots better than where he was taken. {mgr}'s draft was a dumpster fire everywhere else, but {pick} to {finished} is real.",
        "Somewhere around pick {pick}, {mgr} got bored and clicked {player}. {finished} on the season. {beat} spots. That's the whole fucking story.",
        "{beat} places of gain off pick {pick}, {finished} overall. Hate it, respect it, move the fuck on.",
    ],
}
